...
const Pricing = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Тарифы на онлайн курс Python с ИИ | Доступные цены</title>
        <meta
          name="description"
          content="Выберите подходящий тарифный план для изучения Python онлайн с персональным ИИ-учителем. Доступные цены, гибкие условия обучения."
        />
        <meta
          name="keywords"
          content="онлайн курс Python цена, стоимость обучения Python, курсы программирования Python, цены на обучение Python"
        />
      </Helmet>
